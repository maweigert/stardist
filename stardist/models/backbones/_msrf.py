import numpy as np
import keras
from keras.layers import Dense, Dropout,Input,Conv2DTranspose,UpSampling2D,Add, Flatten,Concatenate,Multiply,Conv2D, MaxPooling2D,Activation,GlobalAveragePooling2D,multiply,ZeroPadding2D,GlobalAveragePooling2D,concatenate ,Lambda
...
def RDDB(x, y, nf1=128, nf2=128, gc=64, bias=True):
...
if __name__ == "__main__":
    model = msrf(input_size=(None,None,1))